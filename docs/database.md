...
Изменения опубликованной схемы оформляйте новыми миграциями. `db/schema.sql` принадлежит миграции `0001` и после её публикации не переписывается. Начальная миграция не предлагает автоматического отката с удалением данных.

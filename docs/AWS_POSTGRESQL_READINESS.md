...
This audit covers migration head `0014`. AWS-managed PostgreSQL is the approved
...
3. Capture `0014`, pgvector, TLS verification, role attributes, forced RLS, readiness,

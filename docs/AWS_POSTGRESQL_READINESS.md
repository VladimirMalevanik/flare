...
This audit covers migration head `0017`. AWS-managed PostgreSQL is the approved
...
3. Capture `0017`, pgvector, TLS verification, role attributes, forced RLS, readiness,

...
This audit covers migration head `0013`. AWS-managed PostgreSQL is the approved
...
3. Capture `0013`, pgvector, TLS verification, role attributes, forced RLS, readiness,
